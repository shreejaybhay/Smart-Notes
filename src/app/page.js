        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-6">
              ...
              <span className="text-foreground block">Chaos?</span>
            </h2>
          ...
          <div className="text-center mt-20 pt-16 border-t border-border/50">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Our AI automatically <span className="font-semibold text-foreground">organizes, connects, and surfaces</span> your notes so you can focus on thinking, not searching.
            </p>
          </div>
        </div>
      </section>
